...
<Flow
  nodes={[
    { id: "1", data: { label: "HTML Cleaning" } },
    { id: "2", data: { label: "UI Noise Removal" } },
    { id: "3", data: { label: "Artifact Discovery" } },
    { id: "4", data: { label: "Boilerplate Trim" } },
    { id: "5", data: { label: "Truncation Repair" } },
    { id: "6", data: { label: "Document Gate" } }
  ]}
  edges={[
