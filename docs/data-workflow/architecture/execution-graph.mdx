...
<Flow
  nodes={[
    { id: "1", data: { label: "Source Interleave" } },
    { id: "2", data: { label: "Stage0 Pool" } },
    { id: "3", data: { label: "Clean Pool" } },
    { id: "4", data: { label: "Extract Pool" } },
    { id: "5", data: { label: "Dedup Pool" } },
    { id: "6", data: { label: "Quality Gate" } },
    { id: "7", data: { label: "Apply" } }
  ]}
  edges={[
