...
```bash
git clone https://github.com/indw/indw.git
cd indw
...
Security disclosures follow [SECURITY.md](https://github.com/indw/indw/blob/main/SECURITY.md).

## License

Contributions are licensed under Apache-2.0. See [LICENSE](https://github.com/indw/indw/blob/main/LICENSE).
